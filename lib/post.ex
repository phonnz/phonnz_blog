defmodule PhonnzBlog.Post do
    @enforce_keys [:id, :author, :title, :body, :description, :tags, :date, :path, :language]
    defstruct [:id, :author, :title, :body, :description, :tags, :date, :path, :language, :top_uri, :right_uri, :down_uri, :left_uri]
